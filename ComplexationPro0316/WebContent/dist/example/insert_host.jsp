...
<SCRIPT LANGUAGE="JavaScript">
	...
	function monoSelect() {
		...
		var monos_2 = " "
				...
				+ "style='ime-mode:Disabled'><div id='plus_less_button'><button id='plus'>гл</button> "
			    + "<button id='less'>гн</button></div></div>"
		...
		var mononew_2 = "</div><div id='plus_less_module'>"
		    ...
		    + "<button id='less' onclick=\"lessQuantity('selectMono"+count+"')\">гн</button></div></div><div id='dg_remove'><img src='<%=basePath%>image/delete.png' onClick=\"removeMonoList('selectMono"+count+"')\"></div></div>";
...
<body>
	...
	<table class="table table-condensed">
		<tbody>
			<tr>
				<td colspan="4" style="height: 45px;">Choose from exist host: <span>
						<select id="monoselect" onChange="monoSelect()">
				...
				<td style="border-bottom: 1px solid #ddd; width: 540px" colspan="2">
					<div style="" id="monolist"></div>
				</td>
			...
			<tr>
				...
				<td><input type="text" id="complexation:has_molecular_formular" /></td>
			...
			<tr>
				...
				<td colspan="3"><input type="file" id="image2" name="myfile">
				</td>
			</tr>
			<tr>
				...
				<td style="padding-top: 60px" align="center" rowspan="3">
					<FORM METHOD="POST" NAME="form" ONSUBMIT="return false;">
						...
						<CENTER>
							...
							<p>
								<b>SMILES</b><BR> <INPUT style="width: 300px" TYPE="text"
									NAME="smi" SIZE="48" id="has_smiles"><BR>
							</p>

							<p>
								<b>MOL File</b><BR>
								<TEXTAREA style="width: 300px" NAME="mol_output" ROWS=5 COLS=40
									id="has_mol"></TEXTAREA>
							</P>
						</CENTER>
					</FORM>
			...
			<tr>
				<td colspan="2">
					<button type="button"
						...
						class="btn btn-primary" onClick="submitHostInfo('<%=basePath%>')">Submit
						Host</button>
				</td>
				<td>
